    ...
    async def _scan_single_target(self, target_url):
        ...
        try:
            ...
            if not wpFinder:
                ...
                scan_result['error'] = 'Can not confirm WordPress installation'
            ...
            if self.config.enumerate_users:
                self.logger.log(f"Attempting To Enumerate Users {target_url}...", level='verbose')
                ...
                if users_response and users_response.status_code == 200:
                    try:
                        ...
                        if users:
                            ...
                            self.logger.log(f"no users were found!", level='verbose')
                    except json.JSONDecodeError:
                        self.logger.log(f"Failed to decode JSON from {users_api_url}.", level='warning')
